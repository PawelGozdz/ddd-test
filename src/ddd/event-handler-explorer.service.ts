...
//       Reflect.getMetadata(EVENT_HANDLER_OPTIONS, target) || {};
...
//       console.log(
//         `[DddModule] Pomijanie nieaktywnego handlera klasy: ${target.name}`,
//       );
//       return;
//     }
...
//       console.warn(
//         `[DddModule] Klasa ${target.name} ma dekorator EventHandler, ale nie implementuje metody handle()`,
//       );
//       return;
//     }
...
//     console.log(
//       `[DddModule] Zarejestrowano handler klasy: ${target.name} dla zdarzenia ${metadata.eventType.name}`,
//     );
//   }
...
//       // Pobierz opcje handlera
//       const options: EventHandlerOptions =
//         Reflect.getMetadata(EVENT_HANDLER_OPTIONS, descriptor.value) || {};
//       const defaultActive = this.options.discovery?.defaultActive ?? true;

//       // Sprawdź, czy handler powinien być aktywny
//       if (!this.shouldActivateHandler(options, defaultActive)) {
//         console.log(
//           `[DddModule] Pomijanie nieaktywnego handlera metody: ${instance.constructor.name}.${methodName}`,
//         );
//         return;
//       }
...
//       console.log(
//         `[DddModule] Zarejestrowano handler metody: ${instance.constructor.name}.${methodName} dla zdarzenia ${metadata.eventType.name}`,
//       );
//     });
//   }
...
//       return this.isVersionGreaterOrEqual(
//         this.currentVersion,

...
describe('BusinessPolicy', () => {
  ...
  describe('check', () => {
    ...
    it('should include violation details when provided', () => {
      ...
      const detailsFn = (e: any) => ({ underage: true, requiredAge: 18, actualAge: e.age });
      mockSpecification.isSatisfiedBy.mockReturnValue(false);
  ...
  describe('and/or methods', () => {
    ...
    it('should create composite policy with AND operator', () => {
      // Arrange
      const policy1 = new BusinessPolicy(mockSpecification, 'CODE1', 'Message 1');
      const policy2 = new BusinessPolicy(mockSpecification, 'CODE2', 'Message 2');

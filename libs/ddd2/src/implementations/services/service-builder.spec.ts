...
import { IDomainService, IDomainServiceRegistry, IEventBusAware, IUnitOfWorkAware, IAsyncDomainService, IEventBus, IUnitOfWork } from '../../core';
...
class EventAwareService implements IDomainService, IEventBusAware {
  ...
  constructor(serviceId: string, public readonly dependencies: any[] = []) {
